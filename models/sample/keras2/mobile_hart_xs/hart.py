...
def mobileHART_XS(input_shape,activityCount,projectionDims = [96,120,144],filterCount = [16//2,32//2,48//2,64//2,80,96,384],expansion_factor=4,mlp_head_units = [1024],dropout_rate = 0.3, learning_rate=0.001, regularization_rate=None):
    ...
    #outputs = layers.Dense(activityCount, activation="softmax", kernel_regularizer=l2(regularization_rate))(x)
